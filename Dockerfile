...
RUN CGO_ENABLED=0 GOOS=linux go build \
    -ldflags "-s -w \
      -X github.com/nikx-one/relayly/pkg/version.Version=${VERSION} \
      -X github.com/nikx-one/relayly/pkg/version.Commit=${COMMIT} \
      -X github.com/nikx-one/relayly/pkg/version.BuildTime=${BUILD_TIME}" \
...
LABEL org.opencontainers.image.source="https://github.com/nikx-one/relayly"
